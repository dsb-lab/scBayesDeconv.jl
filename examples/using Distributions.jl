...
#Data
fitca = matread("/home/gabriel/Documents/Acadèmic/PhD/Projects_link/scBayesDeconv.jl/examples/Data/Real_1_multichannel/20191030_FITCA.mat")
percp = matread("/home/gabriel/Documents/Acadèmic/PhD/Projects_link/scBayesDeconv.jl/examples/Data/Real_1_multichannel/20191030_PerCP-Cy5-5-A.mat")
...
n = channel2[1:1000]
t = channel1[1:1000]
c = channel1c[1:1000]+channel2c[1:1000];

#Fit noise
@time dn = infiniteGaussianMixture(reshape(n,length(n),1),k=2,κ0=0.01,ignoreSteps=501,saveSteps=501);

function infiniteGaussianMixtureDeconvolution0(X::Matrix, Y::GaussianInfiniteMixtureModel;
    k = 1,
...
@time dt = infiniteGaussianMixtureDeconvolution0(reshape(c,length(c),1),dn,Σ0=1500*ones(1,1),k=10,κ0=0.01,ν0=0.01,α=1,ignoreSteps=501,saveSteps=501);

#Function

function infiniteGaussianMixtureDeconvolution2(X::Matrix, Y::GaussianInfiniteMixtureModel;
    k = 1,
    initialization::Union{String,Matrix} = "kmeans",
    α = 1,
    ν0 = size(X)[2]+1,
...
@time dt = infiniteGaussianMixtureDeconvolution2(reshape(c,length(c),1),dn,Σ0=1500*ones(1,1),k=10,κ0=0.01,ν0=0.01,α=1,ignoreSteps=501,saveSteps=501);